...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    await query.message.edit_text("Make sure I'm present in your group!!join.", quote=True)
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton("⚡ Jᴏɪɴ Gʀᴏᴜᴘ ⚡", url="https://t.me/bothub33213"),
                              ...
                              InlineKeyboardButton("🔖 Join Group 🔖", url="https://t.me/bothub33213")
                             ]
                            ]
                        )
                    )
        ...
        files_ = await get_file_details(file_id)
        if not files_:
            return await query.answer('No such file exist request on @getrequestbot.')
        files = files_[0]
        title = files.file_name
        size = get_size(files.file_size)
        f_caption = files.caption
